...
@implementation FlutterAEPEdgeIdentityDataBridge
...
+ (AEPIdentityItem *)dictionaryToIdentityItem: (nullable NSDictionary *) dict {
    ...
    AEPAuthenticatedState authenticatedState = [FlutterAEPEdgeIdentityDataBridge authStateFromString:(authenticatedString)];
