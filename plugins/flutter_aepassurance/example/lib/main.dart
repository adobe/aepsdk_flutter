...
import 'package:flutter_assurance/flutter_aepassurance.dart'
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      assuranceVersion = await FlutterAEPAssurance.extensionVersion;
        ...
        body: Center(
          child: ListView(shrinkWrap: true, children: <Widget>[
            ...
            ElevatedButton(
              ...
              onPressed: () => FlutterAEPAssurance.startSession(_url_text),
            ),
          ]),
        ),
      ),
